...
{\color{RoyalBlue} \textbf{Abha Vishwakarma}} (office hours TBD; on Zoom
Sep.~12--20).
...
to a machine. Attendance is at your own discretion, and there are no planned
...
Make a fork of the repo, create a folder with your name for your work,
write/code up your solution as directed in the assignment, commit, and open a
pull request when you are satisfied with your work before Noon the following
Wednesday.
...
\newcommand{\travelrow}[1]{\colorbox{gray!15}{\parbox{\dimexpr\linewidth-2\fboxsep\relax}{#1}}}
...
\item \travelrow{{\bf\headerfont\color{RoyalBlue} Sep 29, Oct 1}\\ Bayes in practice, sampling and Markov Chain Monte Carlo methods (ICVG Ch. 5)}\smallskip
